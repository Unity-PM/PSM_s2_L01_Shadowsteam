...
namespace D
{
    ...
    [CustomEditor (typeof(DWind))]
    public class DWindEditor : Editor
    {
        DWind  wind;
        ...
        void UI_Gizmo()
        {
            ...
            {
                foreach (DWind script in targets)
                {
        ...
        static void DrawGizmosSelected (DWind wind, GizmoType gizmoType)
        {
            // Vars
            int     stepX;
            int     stepZ;
