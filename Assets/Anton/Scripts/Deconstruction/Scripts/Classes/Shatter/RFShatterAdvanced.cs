...
namespace D
{
	...
	public class RFShatterAdvanced
	{
        ...
        public static void RemovePlanar(ref Mesh[] meshes, ref Vector3[] pivots, ref RFDictionary[] origSubMeshIdsRf, DShatter scrShatter)
        {
        ...
        public static void RemoveBySize(ref Mesh[] meshes, ref Vector3[] pivots, ref RFDictionary[] origSubMeshIdsRf, DShatter scr)
        {
		...
		// Limitations ops
		public static void Limitations(DShatter sh)
		{
			SizeLimitation(sh);
			SizeLimitation(sh);
			SizeLimitation(sh);
        ...
        // Size limitation
        static void SizeLimitation(DShatter sh)
		{
        ...
        // Vertex limitation
        static void VertexLimitation(DShatter sh)
        {
        ...
        // Triangle limitation
        static void TriangleLimitation(DShatter sh)
        {
