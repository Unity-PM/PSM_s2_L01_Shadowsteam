...
namespace D
{
    ...
    public class RFCollapse
    {
        ...
        // Start collapse
        public static void StartCollapse(DRigid scr)
        {
            // Not initialized
        ...
        IEnumerator CollapseCor (DRigid scr)
        {
            // Wait time
        ...
        // Start collapse
        public static void StartCollapse(DConnectivity scr)
        {
            // Already running
        ...
        // Stop collapse
        public static void StopCollapse (DConnectivity scr)
        {
            scr.collapse.inProgress = false;
        }

        // Start collapse coroutine
        IEnumerator CollapseCor (DConnectivity scr)
        {
            // Wait time
            WaitForSeconds wait = new WaitForSeconds (duration/steps);
        ...
        public static void AreaCollapse (DRigid scr, int areaPercentage)
        {
        ...
        // Collapse in percents
        public static void SizeCollapse (DRigid scr, int sizePercentage)
        {
        ...
        public static void AreaCollapse (DRigid scr, float minAreaValue)
        {
            // Not initialized
            if (scr.initialized == false)
                return;
        ...
        public static void SizeCollapse (DRigid scr, float minSizeValue)
        {
             // Not initialized
             if (scr.initialized == false)
                 return;
        ...
        public static void RandomCollapse (DRigid scr, int randomValue)
        {
            // Not initialized
            if (scr.initialized == false)
                return;
        ...
        static void CollapseCluster (DRigid scr)
        {
        ...
        // Collapse in percents
        public static void AreaCollapse (DConnectivity connectivity, int areaPercentage)
        {
            areaPercentage = Mathf.Clamp (areaPercentage, 0, 100);
        ...
        // Collapse in percents
        public static void SizeCollapse (DConnectivity connectivity, int sizePercentage)
        {
            sizePercentage = Mathf.Clamp (sizePercentage, 0, 100);
        ...
        // Crumbling
        public static void AreaCollapse (DConnectivity connectivity, float areaValue)
        {
            // Value lower than last
        ...
        // Crumbling
        public static void SizeCollapse (DConnectivity connectivity, float sizeValue)
        {
            // Value lower than last
        ...
        // Crumbling
        public static void RandomCollapse (DConnectivity connectivity, int randomPercentage)
        {
            // Clamp
