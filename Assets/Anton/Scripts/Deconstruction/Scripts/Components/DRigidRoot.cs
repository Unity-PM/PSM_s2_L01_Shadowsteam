...
namespace D
{
    ...
    [AddComponentMenu ("D/D Rigid Root")]
    
    public class DRigidRoot : MonoBehaviour
    {
        ...
        [NonSerialized] public DSound            sound;
        ...
        [NonSerialized] public DUnyielding[]     unyList;
        ...
        // Static
        static          string strRoot = "D RigidRoot: ";
        ...
        void SetComponents()
        {
            ...
            unyList = GetComponents<DUnyielding>();
        }
        ...
        void SetShards()
        {
            ...
            for (int i = 0; i < children.Length; i++)
            {
                ...
                DRigid rigid = children[i].gameObject.GetComponent<DRigid>();
                ...
                else
                {
                    ...
                    rigid.initialization = DRigid.InitType.ByMethod;
                    ...
                    else if (rigid.objectType == ObjectType.MeshRoot)
                    {
                        ...
                        {
                            // Check if already has rigid
                            DRigid meshRootRigid = meshRootChildren[m].GetComponent<DRigid>();
                            ...
                            if (meshRootRigid != null)
                            {
                                ...
                                meshRootRigid.initialization = DRigid.InitType.ByMethod;
        ...
        void AddShard(Transform shardTm, DRigid rigid = null)
        {
            // Has children
        ...
        void AddShardWithRigid(DRigid rigid)
        {
        ...
        */
        ...
        // Shard filter
        static bool ShardFilter(RFShard shard, DRigidRoot scr)
        {
            // No mesh filter
            if (shard.mf == null)
            {
            ...
            // Size check
            if (DMan.colliderSizeStatic > 0)
            {
                if (shard.sz < DMan.colliderSizeStatic)
                {
                    if (DMan.debugStatic == true)
            ...
            if (scr.physics.pc == true && shard.mf.sharedMesh.vertexCount < DMan.coplanarVertLimit)
            {
