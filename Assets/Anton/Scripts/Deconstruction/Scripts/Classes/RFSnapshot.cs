...
namespace D
{
    ...
    public class RFSnapshotAsset
    {
        ...
        public static void Snapshot(GameObject gameObject, bool compress, string assetName)
        {
            ...
            if (tms.Count == 0)
            {
                Debug.Log ("D Snapshot: " + gameObject.name + " has no children", gameObject);
                return;
            }
            ...
            // Set Folder
            string fld = Application.dataPath + "/DSnapshots/";
        ...
        public static void Load(UnityEngine.Object snapshotAsset, GameObject gameObject, float sizeFilter)
        {
            ...
            {
                Debug.Log ("D Snapshot: " + gameObject.name + " Snapshot asset is not defined", gameObject);
                return;
            }
