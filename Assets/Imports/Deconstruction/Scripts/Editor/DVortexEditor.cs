...
namespace D
{
    ...
    [CustomEditor (typeof(DVortex))]
    public class DVortexEditor : Editor
    {
        ...
        void UI_Anchor()
        {
            ...
            {
                foreach (DVortex scr in targets)
                {
        ...
        static void DrawGizmosSelected (DVortex vortex, GizmoType gizmoType)
        {
            if (vortex.showGizmo)
            {
                // Vars
