...
namespace D
{
    ...
    public class RFActivation
    {
        ...
        public DConnectivity cnt; // TODO non serialized
        ...
        public IEnumerator ActivationVelocityCor (DRigid scr)
        {
        ...
        public IEnumerator ActivationOffsetCor (DRigid scr)
        {
            // Skip not activatable uny objects
            if (scr.activation.uny == true && scr.activation.atb == false)
                yield break;
        ...
        public IEnumerator InactiveCor (DRigid scr)
        {
            // Stop if running 
        ...
        public IEnumerator InactiveCor  (DRigidRoot scr)
        {
            // Stop if running 
            if (inactiveCorState == true)
                yield break;
        ...
        public static void ActivateRigid (DRigid scr, bool connCheck = true)
        {
            // Stop if excluded
            ...
            if (DMan.inst.parent != null)
                scr.gameObject.transform.parent = DMan.inst.parent.transform;
        ...
        public static bool ActivateShard (RFShard shard, DRigidRoot rigidRoot)
        {
            ...
            // Parent
            if (DMan.inst.parent != null)
                shard.tm.parent = DMan.inst.parent.transform;
        ...
        // Set activation layer
        static void SetActivationLayer (DRigid scr)
        {
        ...
        public static void RestoreActivationLayer (DRigid scr)
        {
            if (scr.activation.l == true)
        ...
        public static void BackupActivationLayer (DRigid scr)
        {
            if (scr.activation.l == true)
        ...
        public static void RestoreActivationLayer (DRigidRoot root)
        {
        ...
        public static void BackupActivationLayer (DRigidRoot root)
        {
            if (root.activation.l == true)
                for (int i = 0; i < root.cluster.shards.Count; i++)
