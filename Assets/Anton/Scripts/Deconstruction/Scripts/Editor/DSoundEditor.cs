...
namespace D
{
    ...
    [CustomEditor (typeof(DSound))]
    public class DSoundEditor : Editor
    {
        DSound       sound;
            ...
            if (Application.isPlaying == true)
            {
                ...
                if (GUILayout.Button ("Initialization Sound", GUILayout.Height (25)))
                    foreach (var targ in targets)
                        if (targ as DSound != null)
                        {
                            RFSound.InitializationSound (targ as DSound, 0f);
                            (targ as DSound).initialization.played = false;
                        }
            }
            ...
            if (Application.isPlaying == true)
            {
                ...
                if (GUILayout.Button ("Activation Sound", GUILayout.Height (25)))
                    foreach (var targ in targets)
                        if (targ as DSound != null)
                        {
                            RFSound.ActivationSound (targ as DSound, 0f);
                            (targ as DSound).activation.played = false;
                        }
            }
            ...
            if (Application.isPlaying == true)
            {
                ...
                if (GUILayout.Button ("Demolition Sound", GUILayout.Height (25)))
                    foreach (var targ in targets)
                        if (targ as DSound != null)
                        {
                            RFSound.DemolitionSound (targ as DSound, 0f);
                            (targ as DSound).demolition.played = false;
                        }
            }
            ...
            if (Application.isPlaying == true)
            {
                ...
                if (GUILayout.Button ("Collision Sound", GUILayout.Height (25)))
                    foreach (var targ in targets)
                        if (targ as DSound != null)
                        {
                            RFSound.CollisionSound (targ as DSound, 0f);
                            (targ as DSound).collision.played = false;
                        }
            }
