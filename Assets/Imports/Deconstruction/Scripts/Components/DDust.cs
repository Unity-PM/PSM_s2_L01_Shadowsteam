...
{
    [SelectionBase]
    [AddComponentMenu ("D/D Dust")]
    
    public class DDust : MonoBehaviour
    {
        // UI
        ...
        [NonSerialized] public List<DDust> children;
        ...
        // Copy from
        public void CopyFrom(DDust source)
        {
        ...
        public static void CreateDust(DDust scr, MeshFilter emitMeshFilter, int emitMatIndex, ParticleSystem ps)
        {
            // Set main module
