...
namespace D
{
	...
	public static class RFMeshAsset
	{
		...
		static List<GameObject> GetExportObject (DShatter shatter)
		{
        ...
        // Save mesh as asset
        public static void SaveFragments (DShatter shatter, string path)
        {
	        // Get save name
        ...
        public static void SaveFragments(DRigid rigid, string path)
        {
