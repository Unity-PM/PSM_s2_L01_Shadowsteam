...
namespace D
{
    ...
    public static class RFFragment
    {
        ...
        // Cache for shatter
        public static RFShatter CacheMeshes(ref Mesh[] meshes, ref Vector3[] pivots, ref RFDictionary[] rfOrigSubMeshIds, DShatter scrShatter)
        {
        ...
        static bool NoCustomPoints(DShatter scrShatter)
        {
        ...
        public static bool InputMesh(DRigid scr)
        {
            // Set up shatter
        ...
        static bool SetRigidShatter(DRigid scr)
        {
            // Set up shatter
        ...
        // Cache for rigid
        public static void CacheMeshesInst(ref Mesh[] meshes, ref Vector3[] pivots, ref RFDictionary[] rfOrigSubMeshIds, DRigid scrRigid)
        {
            // Local data lists
            List<Dictionary<int, int>> origSubMeshIds = new List<Dictionary<int, int>>();
        ...
        // Cache for rigid
        public static void CacheMeshesMult(Transform tmSaved, ref List<Mesh> meshesList, ref List<Vector3> pivotsList, ref List<RFDictionary> subList, DRigid scrRigid, List<int> batchAmount, int batchInd)
        {
        ...
        // Get demolition mesh
        static Mesh GetDemolitionMesh(DRigid scr)
        {
            if (scr.skr != null)
        ...
        // Get demolition mesh
        static Mesh GetDemolitionMesh(DShatter scr)
        {
        ...
        // Cache for slice
        public static void SliceMeshes(ref Mesh[] meshes, ref Vector3[] pivots, ref RFDictionary[] rfOrigSubMeshIds, DRigid scr, List<Vector3> sliceData)
        {
            // Get mesh
            scr.meshDemolition.mesh = GetDemolitionMesh (scr);
        ...
        // 2:slice
        // 3:bricks
        static int GetShatterMode(DShatter scrShatter = null)
        {
        ...
        // Set fragmentation properties
        static void SetShatterFragmentProperties(RFShatter shatter, DShatter scrSh)
        {
        ...
        // Set fragmentation properties
        static void SetRigidFragmentProperties(RFShatter shatter, DShatter scrSh, DRigid scrRigid)
        {
...
namespace D
{
    public static class RFFragment
    {
        public static bool PrepareCacheMeshes(DRigid scr)
        {
            BuildTest(scr);
            return false;
        }
        ...
        public static void CacheMeshesInst(ref Mesh[] meshes, ref Vector3[] pivots, ref RFDictionary[] origSubMeshIdsRf, DRigid scrRigid)  
        {
            BuildTest();
        }

        public static void CacheMeshes(ref Mesh[] meshes, ref Vector3[] pivots, ref RFDictionary[] origSubMeshIdsRf, DShatter scrShatter)  
        {
            BuildTest();
        }

        public static void SliceMeshes(ref Mesh[] meshes, ref Vector3[] pivots, ref RFDictionary[] origSubMeshIdsRf, DRigid scrRigid, List<Vector3> sliceData)  
        {
            BuildTest();
        }
        ...
        static void BuildTest(DRigid scr)
        {
            //Debug.Log ("Dummy");
        }
