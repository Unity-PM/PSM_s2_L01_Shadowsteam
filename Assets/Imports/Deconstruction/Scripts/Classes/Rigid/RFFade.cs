...
namespace D
{
    ...
    public class RFFade
    {
        ...
        public void DemolitionFade (List<DRigid> fadeObjects)
        {
            // No fading
        ...
        public static IEnumerator FadeOffsetCor (DRigid scr)
        {
        ...
        // Check offset for fade
        public static IEnumerator FadeOffsetCor (DRigidRoot scr)
        {
            // Stop if running 
            if (scr.fading.offsetCorState == true)
                yield break;
        ...
        public static void FadeRigid (DRigid scr)
        {
            // No fading
        ...
        public static void FadeShard (DRigidRoot scr, RFShard shard)
        {
            // No fading
            if (scr.fading.fadeType == FadeType.None)
                return;
        ...
        public static void FadeClusterShards(DRigid scr, List<RFShard> fadeShards)
        {
        ...
        // Start life coroutine
        static IEnumerator LivingCor (DRigid scr)
        {
            // Set living
            scr.fading.state = 1;
            ...
            else if (scr.fading.fadeType == FadeType.Destroy)
            {
                ...
                scr.fading.state = 3;
                DMan.DestroyFragment (scr, scr.rootParent);
            }
        ...
        // Start life coroutine
        static IEnumerator LivingCor (DRigidRoot root, RFShard shard)
        {
            // Wait for simulation get rest
        ...
        // Exclude from simulation and keep object in scene
        static void FadeExclude (DRigid rigid)
        {
            // Set faded
        ...
        // Exclude from simulation and keep object in scene
        static void FadeExclude (DRigidRoot root, RFShard shard)
        {
            // Faded
            shard.fade = 3;
        ...
        // Exclude from simulation, fall under ground, destroy
        static IEnumerator FallDownCor (DRigid rigid)
        {
            // Activate inactive
            ...
            DMan.DestroyFragment (rigid, rigid.rootParent);
        }
        
        // Exclude from simulation, move under ground, destroy
        static IEnumerator FallDownCor (DRigidRoot root, RFShard shard)
        {
            // Activate inactive
        ...
        // Exclude from simulation, move under ground, destroy
        static IEnumerator ScaleDownCor (DRigid scr)
        {
        ...
        // Exclude from simulation, move under ground, destroy
        static IEnumerator ScaleDownCor (DRigidRoot root, RFShard shard)
        {
            // Scale object down during fade time
            float   waitStep   = 0.04f;
        ...
        // Exclude from simulation, fall under ground, destroy
        static IEnumerator FadeMoveDownCor (DRigid rigid)
        {
            // Stop simulation
        ...
        // Exclude from simulation, move under ground, destroy
        static IEnumerator FadeMoveDownCor (DRigidRoot root, RFShard shard)
        {
            // Stop simulation
        ...
        static void DisableClusterColliders (DRigid rigid)
        {
        ...
        static public void SetOffsetFadeList (DRigidRoot root)
        {
