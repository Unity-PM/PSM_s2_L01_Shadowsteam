...
namespace D
{
    public static class RFRecorder
    {
        ...
        public static void ExportAssets(DRigid rigid,  DRecorder recorder)
        {
        ...
        static void ExportMeshes(List<MeshFilter> meshFilters, string rootName, string clipName)
        {
            ...
            string folderMeshes = "Assets/DRecords/" + clipName + "_meshes/";
        ...
        // Export prefabs
        static void ExportPrefabs(DRigid rigid, DRecorder recorder)
        {
            // Create prefab folder
            string folderPrefab = "Assets/DRecords/" + recorder.clipName + "_prefabs/";
        ...
        public static void DestroyPrefabComponents(List<GameObject>   pfList)
        {
            ...
            foreach (var pf in pfList)
            {
                ...
                DRigid[] rgs = pf.GetComponentsInChildren<DRigid>();
