...
namespace D
{
    ...
    public class RFStress
    {
        ...
        // Stop stress check
        public static void StopStress (DConnectivity scr)
        {
            scr.stress.inProgress = false;
        }

        // Initiate stress check
        public static void StartStress (DConnectivity scr)
        {
            // Already running
        ...
        IEnumerator StressCor (DConnectivity scr)
        {
            // Set state
        ...
        bool CheckSupport (DConnectivity scr)
        {
        ...
        static void StressErosion (DConnectivity scr)
        {
        ...
        static void StressCollapse (DConnectivity connectivity, int maxStressValue)
        {
        ...
        // Set Stress
        public static void Initialize (DConnectivity conn)
        {
        ...
        static bool InitializeNeed (DConnectivity conn)
        {
        ...
        // Set Stress data 
        static void SetStressConnections (DConnectivity conn)
        {
            // Set list
        ...
        static void SetSizeMultiplier (DConnectivity conn)
        {
            // 63162 / 6.45
        ...
        static void SetSizeMultiplierOLD (DConnectivity conn)
        {
            // 63162 / 6.45
