...
namespace D
{
    ...
    public class RFLimitations
    {
        ...
        [NonSerialized] public DRigid       anc;  // ancestor
        [NonSerialized] public List<DRigid> desc; // descendants
        
        // Static
        static        float  kinematicCollisionMult = 7f;
        static        string rootStr                = "_root";
        public static string rigidStr               = "D Rigid: ";
        ...
        public IEnumerator DemolishableCor(DRigid scr)
        {
            // Stop if running 
            if (dmlCorState == true)
                yield break;
        ...
        public static void MeshRootCheck (DRigid scr)
        {
            // Null fragments
        ...
        public static void Checks (DRigid scr)
        {
            // ////////////////
            // Sim Type
            // ////////////////
        ...
        // Set bound and size
        public static void SetBound (DRigid scr)
        {
            if (scr.objectType == ObjectType.Mesh)
        ...
        // Set ancestor
        public static void SetAncestor (DRigid scr)
        {
        ...
        // Set descendants 
        public static void SetDescendants (DRigid scr)
        {
        ...
        // Create root
        public static void CreateRoot (DRigid rfScr)
        {
        ...
        public bool CollisionCheck(DRigid rigid)
        {
        ...
        // Collision force checks. Uses relativeVelocity
        public bool DamagePointsCheck(Collision collision, DRigid rigid)
        {
            float collisionMagnitude = collision.relativeVelocity.magnitude;
            for (int i = 0; i < collision.contactCount; i++)
            {
