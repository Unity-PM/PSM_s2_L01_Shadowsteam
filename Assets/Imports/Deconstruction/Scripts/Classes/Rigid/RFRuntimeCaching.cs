...
namespace D
{
    ...
    public class RFRuntimeCaching
    {
        ...
        // Create tm reference
        public static GameObject CreateTmRef(DRigid rfScr)
        {
            ...
            go.transform.parent = DMan.inst.transform;
            return go;
        }
        ...
        public IEnumerator RuntimeCachingCor (DRigid scr)
        {
        ...
        // Reset caching
        void ResetRuntimeCaching (DRigid scr, GameObject tmRefGo)
        {
            scr.DestroyObject (tmRefGo);
            stop = false;
            inProgress = false;
