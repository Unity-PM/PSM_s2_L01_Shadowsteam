...
namespace D
{
    ...
    public class RFDamage
    {
        ...
        // Apply damage
        public static bool ApplyDamage (DRigid scr, float value, Vector3 point, float radius, Collider collider)
        {
            // Initialize if not
        ...
        // Add damage
        public static bool ApplyTo(DRigid scr, float value, Vector3 point, float radius = 0f, Collider collider = null)
        {
        ...
        // Add damage to Rigid
        public static bool ApplyToRigid(DRigid scr, float damageValue)
        {
            // Add damage
        ...
        // Add damage to shard
        public static bool ApplyToShard (DRigid scr, float value, Vector3 point, float radius, Collider collider)
        {
        ...
        public static bool ApplyToShard(DRigid scr, float value, Collider collider)
        {
        ...
        public static bool ApplyToShards(DRigid scr, float value, Vector3 point, float radius)
        {
