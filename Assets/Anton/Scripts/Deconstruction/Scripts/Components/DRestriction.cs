...
namespace D
{
    ...
    [AddComponentMenu ("D/D Restriction")]
    
    public class DRestriction : MonoBehaviour
    {
        ...
        // Copy from
        public void CopyFrom (DRestriction rest)
        {
            enable        = rest.enable;
        ...
        // Init restriction check
        public void InitRestriction (DRigid scr)
        {
            // Skip in Editor
        ...
        static void BrokeRestriction (DRigid scr)
        {
            // Set state
            scr.rest.broke = true;
        ...
        static IEnumerator RestrictionDistanceCor (DRigid scr)
        {
            // Wait random time
        ...
        // Start Trigger check
        IEnumerator RestrictionTriggerCor (DRigid scr)
        {
            // Wait random time
