...
namespace D
{
    ...
    public class RFSound
    {
        ...
        // Copy sound to Rigid
        public static void CopySound (DSound source, DRigid target)
        {
            if (source != null)
            {
                target.sound = target.gameObject.AddComponent<DSound>();
        ...
        public static void CopySound (DSound source, List<DRigid> targets)
        {
            if (source != null)
            {
                for (int i = 0; i < targets.Count; i++)
                {
                    targets[i].sound = targets[i].gameObject.AddComponent<DSound>();
        ...
        // Play
        public static void Play(DSound scr, RFSound sound, float volume)
        {
            // Has output group
            if (sound.outputGroup != null)
            {
                ...
                audioObject.transform.parent = DMan.inst.transform;
        ...
        public static void InitializationSound (DSound scr, float size)
        {
            // Null
            if (scr == null)
                return;
        ...
        // Activation sound
        public static void ActivationSound (DSound scr, float size)
        {
            // Null
            if (scr == null)
                return;
        ...
        // Demolition sound
        public static void DemolitionSound (DSound scr, float size)
        {
            // Null
            if (scr == null)
                return;
        ...
        // Demolition sound
        public static void CollisionSound (DSound scr, float size)
        {
            // Null
            if (scr == null)
                return;
        ...
        // Get volume
        public static float GeVolume (DSound scr, float size)
        {
        ...
        // Filters check
        static bool FilterCheck (DSound scr, float size)
        {
            // Small size
